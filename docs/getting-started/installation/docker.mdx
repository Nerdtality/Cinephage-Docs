...
For more troubleshooting help, see the [Troubleshooting Guide](/docs/guides/deploy/troubleshooting).

## Next Steps

- [Initial Setup](/docs/getting-started/initial-setup) - Configure download clients, indexers, and quality profiles
- [Environment Variables Reference](/docs/reference/configuration/environment-variables) - Complete list of configuration options
